...
const translations = {
  en: {
    ...
    categoryModeTooltip: 'Original: classic 7 categories. Custom: create your own categories.',
    addCategory: 'Add a category...',
    customCategoryWarning: 'Custom categories require manual answer approval after each round.',
    customCategoryReminder: 'Answers are not auto-verified in custom mode. Players will review answers after the round.',
  ...
  bs: {
    ...
    categoryMode: 'Kategorije',
    categoryOriginal: 'Originalne',
    categoryCustom: 'Prilagođene',
    categoryModeTooltip: 'Originalne: klasičnih 7 kategorija. Prilagođene: kreirajte vlastite kategorije.',
    addCategory: 'Dodaj kategoriju...',
    customCategoryWarning: 'Prilagođene kategorije zahtijevaju ručno odobravanje odgovora nakon svake runde.',
    customCategoryReminder: 'Odgovori se ne provjeravaju automatski u prilagođenom modu. Igrači će pregledati odgovore nakon runde.',
    ...
    // Connection
    disconnected: 'Veza izgubljena. Pokušavamo ponovo...',
